...
<ul className="list-disc pl-4 mt-2 text-[13px] opacity-85">
  ...
  <li>
    <strong>Discord Server Boosts:</strong> Boost your server&apos;s performance and engagement with our <em>Discord server boosts</em>. Enjoy improved audio quality  and better visibility in the server list.
  </li>
  <li>
  ...
  <li>
    <strong>Viral & Aged Instagram Accounts:</strong> Explore our selection of <em>viral Instagram accounts</em> with real followers.
  </li>
  <li>
    <strong>Reddit Accounts:</strong> Engage in the Reddit community with our <em>aged, active Reddit accounts</em>.
  </li>
</ul>
