      ...
      <div className="bg-[#121212] py-12">
        <div className="max-w-[1280px] mx-auto px-7 sm:px-12 text-white relative min-h-[60vh] w-[100%] ">
          ...
          <p className="opacity-80 mt-5 text-[15px] w-[98%] md:w-[80%]">
            ...
            . Each account is meticulously chosen to ensure exclusivity,
            quality, and a seamless experience for our users. Whether
            you&apos;re a gamer looking for the perfect Discord community or a
            social media enthusiast seeking a premium Instagram or account,
            Discord Arena is your ultimate destination.
          </p>
          ...
          <p className="opacity-80 mt-5 text-[15px] w-[98%] md:w-[80%] mb-10">
            ...
            Discord, Instagram, and accounts.
