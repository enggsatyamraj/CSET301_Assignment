    ...
    <div className="min-h-[100vh] w-[100%] bg-[#121212] text-white">
      <div className="mx-auto max-w-[800px] px-7 pb-12 pt-[100px]">
        ...
        <p className="text-[15px] opacity-80 md:text-[1.15rem]">
          ...
          Instagram account from here with decent price. Interested members will
          contact me in Instagram or Telegram.
        </p>
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
          ...
          <div>
            <p className="mb-5 text-2xl">Buy {data.year} Instagram Account </p>
