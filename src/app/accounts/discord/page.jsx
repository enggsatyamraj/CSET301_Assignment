...
export const generateMetadata = () => {
  ...
  const keywords =
  ["Aged Discord accounts", "buy Discord accounts", "premium Discord accounts", "verified Discord accounts", "custom handle Discord accounts", "Discord server management", "Discord community building", "buy social media accounts", "Discord account sales", "secure Discord accounts"];
