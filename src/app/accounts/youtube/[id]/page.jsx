...
import discordServerBoostData from "../../../../dataFolder/youtube.json";
      ...
      <div className="min-h-[100vh] w-[100%] bg-[#121212] text-white">
        <div className="mx-auto max-w-[800px] px-7 pb-12 pt-[100px]">
          <h1 className="mx-auto  text-2xl sm:text-3xl md:text-4xl">
            Buy {data.type} Accounts for sale-
          ...
          <div className="mt-4 flex flex-col sm:flex-row gap-5 mb-7">
          ...
          <p className="mb-3 mt-5 text-2xl font-semibold">
            Features and benefits of used aged youtube account - {data.year}
          </p>
          ...
          <h2 className="mb-3 mt-5 text-2xl font-semibold">
            FAQs related to aged aged youtube account - {data.year}
          </h2>
          <div>
