...
export const generateMetaData = () => {
  const jsonLd = {
    ...
    name: "Discord Arena",
    description:
      "Discover a diverse selection of aged Discord acounts and Discord Server Boosts at unbeatable prices. Buy Discord accounts from 2015 and beyond, with the assurance of authenticity and quality. Our collection includes aged Discord accounts for sale, providing you with established communities and high-engagement profiles. We offer verified Discord accounts for sale, ensuring credibility and trustworthiness. Additionally, explore our range of services to buy Discord server boosts, enhancing your server's visibility and reach. Elevate your presence with our solutions to buy established Discord Servers, boosting your social proof and influence. Explore our selection of aged social media accounts like instagram, reddit and Youtube as well, tailored to meet your specific needs. Join the ranks of successful influencers, marketers, and businesses who have leveraged our premium accounts to achieve their goals. Experience growth, credibility, and success like never before. Unlock the power of established social media accounts today.",
