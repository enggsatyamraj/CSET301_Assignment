...
export const generateMetadata = () => {
  ...
  return {
    ...
    description:
      "Find answers to your questions about buying aged Discord accounts and premium social media profiles at Discord Arena's FAQ section.",
    keywords:
    ["Discord Arena FAQs", "aged accounts questions", "buying guide", "premium social media profiles", "customer support", "Discord Nitro sale", "verified Discord accounts", "social media account purchase", "troubleshooting", "account recovery help"],
    openGraph: {
      title:
    ...
    <div className={actor.className}>
      ...
      <div className="bg-normal w-[100%] min-h-[100vh] text-white pt-[100px] pb-10 px-7 sm:px-12 relative">
        <PageWrapper>
         ...
         Explore our Frequently Asked Questions page to get detailed answers to all your questions about our services at Buy Discord Now. Whether you&apos;re curious about our offerings, processes, or customer support, we&apos;ve got you covered with the information you need.
        </p>
            <div className="">
