...
const WhyChoose = () => {
  const pointsArray = [
    ...
    },
    {
      ...
      description: "Every business is unique, and we understand that. We offer personalized solutions that are customized to your specific needs, ensuring that you get exactly what you need to succeed in your digital endeavors. Our tailored solutions encompass SEO optimization, social media engagement, and brand visibility."
    },
    {
      title: "Keyword Optimization",
      description: "Boost your online presence with our keyword optimization strategies. We conduct in-depth research to identify and target the most relevant keywords for your business, ensuring maximum visibility and reach."
    },
    {
      title: "Data-Driven Approach",
      description: "Harness the power of data with our data-driven approach. We analyze user behavior, trends, and metrics to refine and optimize your strategies, delivering data-backed results that propel your business forward."
    },
  ];
  ...
  return (
    <div className="bg-[#121212] text-white py-12">
      <Head>
        ...
        <meta name="description" content="Discover the reasons to choose Discord Arena for top-notch expertise, quality assurance, customer satisfaction, innovation, transparent pricing, tailored solutions, keyword optimization, and a data-driven approach." />
      ...
      <div className="max-w-[1080px] min-h-[60vh] mx-auto flex flex-col justify-center px-4 pb-12">
        <div className=" ">
          <b className="md:text-4xl text-3xl font-semibold mb-6 w-[98%] sm:w-[80%] md:w-[70%] lg:w-[60%]">Elevate Your Strategy with Our Trusted Solutions</b>
          <ul>
            {pointsArray.map((item, index) => (
              <li key={index} className="mb-8 relative max-w-[900px] border-[1px] p-4 rounded-lg">
                <b className="sm:text-[17px] text-[15px] font-semibold absolute bg-[#dcdcdc] px-2 text-[#121212] rounded-md -top-[15px]">{item.title}</b>
